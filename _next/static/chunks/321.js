  ...
  [321],
  {
    657: function (e, t) {
      ...
      (c.promise = (e) => c.nativePromise(e) || d(e)),
        ...
        (c.primitive = (e) => {
          var t;
          return c.null_(e) || ((t = typeof e), i.includes(t));
        }),
      ...
      let p = (e) => c.safeInteger(e) && e >= 0;
      (c.arrayLike = (e) =>
        !c.nullOrUndefined(e) && !c.function_(e) && p(e.length)),
        (c.inRange = (e, t) => {
    ...
    3390: function (e) {
      ...
      var N = Object.freeze({
        ...
        NUMBER_MODE: { scope: "number", begin: k, relevance: 0 },
        NUMBER_RE: k,
        PHRASAL_WORDS_MODE: {
          begin:
      ...
      let Z = Symbol("nomatch"),
        V = function (e) {
          ...
          function k(e, t, n) {
            ...
            let o = a.result ? a.result : w(a.language, a.code, n);
          ...
          function w(e, a, o, c) {
              ...
              null != F.subLanguage
                ? (function () {
                    ...
                    if ("string" == typeof F.subLanguage) {
                      ...
                      (e = w(F.subLanguage, z, !0, N[F.subLanguage])),
                        (N[F.subLanguage] = e._top);
                    } else
            ...
            function m(e, t) {
              "" !== e && (S.startScope(t), S.addText(e), S.endScope());
            }
            function g(e, t) {
              let n = 1,
                r = t.length - 1;
            ...
            function b(e, t) {
              return (
                e.scope &&
                  ...
                  S.openNode(E.classNameAliases[e.scope] || e.scope),
                e.beginScope &&
                  (e.beginScope._wrap
                    ? (m(
                        z,
            ...
            let z = "",
              ...
              q = !1;
            try {
              if (E.__emitTokens) E.__emitTokens(a, S);
              else {
          ...
          function E(e) {
            ...
            let n = e.textContent,
              r = t ? k(n, { language: t, ignoreIllegals: !0 }) : x(n);
            (e.innerHTML = r.value),
    ...
    8367: function (e, t, n) {
      ...
      let r = /[ \t\n\f\r]/g;
      function i(e) {
        return "object" == typeof e ? "text" === e.type && a(e.value) : a(e);
      }
      function a(e) {
        return "" === e.replace(r, "");
      }
                    ...
                    for (; ++r < n.length; ) {
                      ...
                      if (i) {
                        if (
                          ...
                          let e = i.children[0];
                          e && "text" === e.type && (e.value = k(e.value));
                        }
    ...
    9360: function (e, t, n) {
      ...
      var w = "[0-9](_*[0-9])*",
        ...
        D = {
          ...
          variants: [
            {
              begin: `(\\b(${w})((${x})|\\.)?|(${x}))[eE][+-]?(${w})[fFdD]?\\b`,
            },
            { begin: `\\b(${w})((${x})[fFdD]?\\b|\\.([fFdD]\\b)?)` },
            { begin: `(${x})[fFdD]?\\b` },
            { begin: `\\b(${w})[fFdD]\\b` },
            {
              begin: `\\b0[xX]((${E})\\.?|(${E})?\\.(${E}))[pP][+-]?(${w})[fFdD]?\\b`,
            },
            { begin: "\\b(0|[1-9](_*[0-9])*)[lL]?\\b" },
            { begin: `\\b0[xX](${E})[lL]?\\b` },
            { begin: "\\b0(_*[0-7])*[lL]?\\b" },
        ...
        eg = {
          arduino: function (e) {
            let t = (function (e) {
                let t = e.regex,
                  ...
                  m = [f, c, o, n, e.C_BLOCK_COMMENT_MODE, s, l],
                  g = {
                    variants: [
                      { begin: /=/, end: /;/ },
                      { begin: /\(/, end: /\)/ },
          ...
          c: function (e) {
            let t = e.regex,
              ...
              f = [c, o, n, e.C_BLOCK_COMMENT_MODE, s, l],
              m = {
                variants: [
                  { begin: /=/, end: /;/ },
                  { begin: /\(/, end: /\)/ },
            ...
            return {
              ...
              exports: { preprocessor: c, strings: l, keywords: p },
            };
          },
          cpp: function (e) {
            let t = e.regex,
          ...
          javascript: function (e) {
            ...
            return {
              ...
              keywords: o,
              exports: { PARAMS_CONTAINS: A, CLASS_REFERENCE: S },
              illegal: /#(?![$_A-z])/,
              contains: [
          ...
          php: function (e) {
            let t = e.regex,
              ...
              d = "[ 	\n]",
              p = { scope: "string", variants: [s, l, c, u] },
              f = {
                scope: "number",
                variants: [
              ...
              x = {
                ...
                keywords: b,
                contains: [w, a, k, e.C_BLOCK_COMMENT_MODE, p, f, _],
              },
              E = {
                relevance: 0,
                match: [
            ...
            x.contains.push(E);
            let D = [w, k, e.C_BLOCK_COMMENT_MODE, p, f, _];
            return {
              case_insensitive: !1,
              keywords: b,
              contains: [
                ...
                _,
                {
                  ...
                  contains: [
                    ...
                    { begin: "=>", endsParent: !0 },
                    {
                      ...
                      excludeEnd: !0,
                      keywords: b,
                      contains: ["self", a, k, e.C_BLOCK_COMMENT_MODE, p, f],
                    },
                  ],
                },
                {
          ...
          swift: function (e) {
            let t = { match: /\s+/, relevance: 0 },
              ...
              a = { match: $(/\./, U(...V)), relevance: 0 },
              o = V.filter((e) => "string" == typeof e).concat(["_|0"]),
              l = {
                variants: [
                  {
                    className: "keyword",
                    match: U(
                      ...V.filter((e) => "string" != typeof e)
                        .concat(Z)
                        .map(q),
                      ...K,
                    ),
              ...
              c = [i, a, l],
              u = [
                { match: $(/\./, U(...X)), relevance: 0 },
                { className: "built_in", match: $(/\b/, U(...X), /(?=\()/) },
              ],
              d = { match: /->/, relevance: 0 },
              p = [
                d,
          ...
          typescript: function (e) {
            let t = (function (e) {
                ...
                return {
                  ...
                  aliases: ["js", "jsx", "mjs", "cjs"],
                  keywords: o,
                  exports: { PARAMS_CONTAINS: _, CLASS_REFERENCE: w },
                  illegal: /#(?![$_A-z])/,
                  contains: [
                    e.SHEBANG({
                      label: "shebang",
      ...
      function ew(e) {
        ...
        return function (e, t) {
          (0, ev.Vn)(e, "element", function (e, n, a) {
            ...
            let p = (function (e) {
              let t;
              let n = e.properties.className,
                r = -1;
              if (Array.isArray(n)) {
                for (; ++r < n.length; ) {
                  let e = String(n[r]);
                  if ("no-highlight" === e || "nohighlight" === e) return !1;
                  t || "lang-" !== e.slice(0, 5) || (t = e.slice(5)),
                    t || "language-" !== e.slice(0, 9) || (t = e.slice(9));
                }
                return t;
              }
            })(e);
            if (!(!1 === p || (!p && !i) || (p && o && o.includes(p)))) {
              ...
              try {
                d = p
                  ? u.highlight(p, (0, r.l)(a), { prefix: l })
        ...
        return function (n, l, ...d) {
          ...
          if (null == n) (f = { type: "root", children: [] }), d.unshift(l);
            ...
            if (
              ...
              r && u.call(r, f.tagName) && (f.tagName = r[f.tagName]),
              (g = f.tagName),
      ...
      function E(e) {
        ...
        return function (e, n) {
          (0, k.S4)(e, "element", function (e, r) {
            ...
            let g = u.children.indexOf(d);
            return u.children.splice(g, 1, ...i), k.AM;
          });
        };
      }
    },
    2609: function (e, t, n) {
      ...
      let y = {}.hasOwnProperty,
        ...
        v = /[A-Z]/g,
        k = /-([a-z])/g,
        w = new Set(["table", "tbody", "thead", "tfoot", "tr"]),
        x = new Set(["td", "th"]),
              ...
              let o = N(e, t.tagName, !1),
                l = (function (e, t) {
                  ...
                  for (i in t.properties)
                    if ("children" !== i && y.call(t.properties, i)) {
                      let o = (function (e, t, n) {
                        let i = (0, d.s)(e.schema, t);
                        if (
                          !(
                            null == n ||
              ...
              return (
                w.has(t.tagName) &&
                  (s = s.filter(function (e) {
                    return "string" != typeof e || !(0, c.Q)(e);
                  })),
                C(e, l, o, t),
                A(l, s),
                e.ancestors.pop(),
            ...
            : "mdxJsxFlowElement" === t.type || "mdxJsxTextElement" === t.type
              ...
              : "mdxjsEsm" === t.type
                ...
                : "root" === t.type
                  ? (function (e, t, n) {
                      let r = {};
                      return A(r, F(e, t)), e.create(t, e.Fragment, r, n);
                    })(e, t, n)
                  : "text" === t.type
                    ? t.value
                    : void 0;
      ...
      function S(e, t) {
        ...
        throw (
          ((n.file = e.filePath || void 0),
          (n.url = E + "#cannot-handle-mdx-estrees-without-createevaluater"),
          n)
        );
      }
      function O(e, t) {
    ...
    8848: function (e, t, n) {
            ...
            if (S || !1 !== t.nonTerminated) {
              if (F) {
                if ("named" === n) {
                  ...
                  if (((k = e) >= 55296 && k <= 57343) || k > 1114111)
                    E(7, O), (M = u(65533));
        ...
        if (
          ((c += o.move(
            (function (e, t) {
              ...
              function u(e, t) {
                return e + (t ? "=" + o + (0, f.q)(t, { subset: l }) + o : "");
              }
            })(e, n),
          )),
          "containerDirective" === e.type)
      ...
      var T = n(2761),
        I = n(5459),
        B = n(6226);
      function L(e, t, n, r, i, a, o, l, s, c, u, d, p, f, m) {
        let g, h;
        return function (t) {
        ...
        function b(t) {
          return 35 === t
            ...
            : 46 === t
              ? ((g = l), y(t))
              : 58 === t || 95 === t || (0, I.jv)(t)
                ? (e.enter(a), e.enter(s), e.consume(t), k)
                : m && (0, I.xz)(t)
        ...
        function k(t) {
          return 45 === t || 46 === t || 58 === t || 95 === t || (0, I.H$)(t)
            ? (e.consume(t), k)
            : (e.exit(s), m && (0, I.xz)(t))
              ? (0, T.f)(e, w, "whitespace")(t)
              : !m && (0, I.z3)(t)
                ? (0, B.S)(e, w)(t)
                : w(t);
        }
        ...
        function x(t) {
          return null === t ||
            ...
            ? n(t)
            : 34 === t || 39 === t
              ? (e.enter(u), e.enter(p), e.consume(t), e.exit(p), (h = t), D)
              : m && (0, I.xz)(t)
        ...
        function D(t) {
          return t === h
            ? (e.enter(p), e.consume(t), e.exit(p), e.exit(u), e.exit(a), F)
            : (e.enter(d), C(t));
        }
        function C(t) {
          return t === h
        ...
        function A(t) {
          return t === h || null === t || (0, I.Ch)(t)
            ? (e.exit(f), C(t))
            : (e.consume(t), A);
        }
        function F(e) {
          return 125 === e || (0, I.z3)(e) ? b(e) : N(e);
        }
        function N(a) {
          return 125 === a
      ...
      function z(e, t, n, r) {
        let i = this;
        return function (t) {
          return (0, I.jv)(t) ? (e.enter(r), e.consume(t), a) : n(t);
        };
        function a(o) {
          return 45 === o || 95 === o || (0, I.H$)(o)
            ? (e.consume(o), a)
      ...
      let P = {
            ...
            function g(t) {
              ...
              return (
                ...
                (function t(n) {
                  ...
                  return (0, I.Ch)(n) ? e.check(U, h, b)(n) : (e.consume(n), t);
                })(t)
              );
            }
            function h(t) {
        ...
        Z = {
          tokenize: function (e, t, n) {
            ...
            function i(t) {
              return 58 === t ? n(t) : 91 === t ? e.attempt(V, a, a)(t) : a(t);
            }
            function a(t) {
              return 123 === t ? e.attempt(G, o, o)(t) : o(t);
            }
            function o(n) {
        ...
        t.push({ text: { 58: Z }, flow: { 58: [P, q] } }),
          n.push({
            ...
            exit: {
              ...
              directiveContainerAttributes: N,
              directiveContainerLabel: x,
              directiveContainerName: k,
              directiveLeaf: S,
    ...
    7423: function (e, t, n) {
      ...
      function N(e, t, n, r) {
        ...
        return (
          ...
          i.shift(4),
          (a += i.move(n.indentLines(n.containerFlow(e, i.current()), S))),
          o(),
          a
        );
      }
      ...
      let X = {
            ...
            return function (t) {
              return (87 !== t && 119 !== t) ||
                ...
                : (e.enter("literalAutolink"),
                  ...
                  e.check(X, e.attempt(Y, e.attempt(J, i), n), n)(t));
            };
            function i(n) {
              return (
        ...
        ei = {
          tokenize: function (e, t, n) {
            ...
            let o = this;
            return function (t) {
              return !eu(t) || !ec.call(o, o.previous) || ed(o.events)
                ? n(t)
                : (e.enter("literalAutolink"),
          ...
          "enter" === f[0]
            ...
            : "tableHead" === m.type
              ...
              : "tableRow" === m.type || "tableDelimiterRow" === m.type
                ? ((d = a),
                  0 !== s[1]
                    ? ((c[0] = c[1]), (i = eA(p, t, s, l, a, i)))
                    : 0 !== c[1] && (i = eA(p, t, c, l, a, i)),
                  (l = 0))
                : l &&
                  ("data" === m.type ||
                    "tableDelimiterMarker" === m.type ||
      ...
      function eA(e, t, n, r, i, a) {
        0 !== n[0] &&
          ((a.end = Object.assign({}, eN(t.events, n[0]))),
          e.add(n[0], 0, [["exit", a, t]]));
        let o = eN(t.events, n[1]);
        if (
          ((a = {
            type:
              1 === r
        ...
        return (
          void 0 !== i &&
            ((a.end = Object.assign({}, eN(t.events, i))),
            e.add(i, 0, [["exit", a, t]]),
            (a = void 0)),
          a
        );
          ...
          a.push({
            extensions: [
              ...
              },
              {
                ...
                handlers: { footnoteDefinition: N, footnoteReference: F },
              },
              {
                unsafe: [
                  {
              ...
              (function (e) {
                ...
                function l(e, t) {
                  return (function (e, t = {}) {
                    ...
                    a.splice(1, 0, p), o.splice(1, 0, f), (c = -1);
                    let m = [];
                    for (; ++c < a.length; ) {
                      let e = a[c],
                        n = o[c];
    ...
    3219: function (e, t, n) {
      ...
      var r = n(2835),
        i = n(3980);
      let a = ["ariaDescribedBy", "ariaLabel", "ariaLabelledBy"],
        o = {
          ancestors: {
            tbody: ["table"],
            td: ["table"],
          ...
          attributes: {
            ...
            ol: [...a, ["className", "contains-task-list"]],
            q: ["cite"],
            section: ["dataFootnotes", ["className", "footnotes"]],
            source: ["srcSet"],
            summary: [...a],
            table: [...a],
            ul: [...a, ["className", "contains-task-list"]],
            "*": [
              "abbr",
              "accept",
              "acceptCharset",
      ...
      function s(e, t) {
        if (t && "object" == typeof t)
          switch ("string" == typeof t.type ? t.type : "") {
            ...
            case "element":
              return (function (e, t) {
                ...
                let r = c(e, t.children),
                  i = (function (e, t) {
                    ...
                    let r = e.stack[e.stack.length - 1],
                      ...
                      a = e.schema.required,
                      o = i && l.call(i, r) ? i[r] : void 0,
                      s = i && l.call(i, "*") ? i["*"] : void 0,
                    ...
                    for (n in c)
                      if (l.call(c, n)) {
                        let t = c[n],
                          r = u(e, f(o, n), n, t);
                        null == r && (r = u(e, f(s, n), n, t)),
                          null != r && (d[n] = r);
                      }
                    if (a && l.call(a, r)) {
                      let e = a[r];
                      for (n in e)
                        l.call(e, n) && !l.call(d, n) && (d[n] = e[n]);
                    }
                    return d;
                  })(e, t.properties);
                e.stack.pop();
                ...
                if (
                  ...
                  ((a = !0),
                  e.schema.ancestors && l.call(e.schema.ancestors, n))
                ) {
            ...
            case "root":
              return (function (e, t) {
                let n = { type: "root", children: c(e, t.children) };
                return p(n, t), n;
              })(e, t);
            case "text":
              return (function (e, t) {
      ...
      function d(e, t, n, r) {
        if (
          ...
          (function (e, t, n) {
            let r =
              e.schema.protocols && l.call(e.schema.protocols, t)
      ...
      function p(e, t) {
        let n = (0, i.FK)(t);
        t.data && (e.data = (0, r.ZP)(t.data)), n && (e.position = n);
      }
      function f(e, t) {
        let n;
        let r = -1;
      ...
      function S(e) {
        return function (t, n, r) {
          let i = t ? t.children : N,
            a = (n || 0) + e,
            o = i[a];
          if (!r) for (; o && (0, C.Q)(o); ) (a += e), (o = i[a]);
          return o;
        };
      }
      ...
      function M(e) {
        return function (t, n, r) {
          return O.call(e, t.tagName) && e[t.tagName](t, n, r);
        };
      }
      let T = M({
        body: function (e, t, n) {
      ...
      function I(e, t, n) {
        ...
        return (
          !r ||
          ("comment" !== r.type &&
            !("text" === r.type && (0, C.Q)(r.value.charAt(0))))
        );
      }
      function B(e, t, n) {
        let r = A(n, t);
      ...
      let R = M({
          body: function (e) {
            ...
            return (
              !t ||
              ("comment" !== t.type &&
                !("text" === t.type && (0, C.Q)(t.value.charAt(0))) &&
                !(
                  "element" === t.type &&
                  ("meta" === t.tagName ||
                    "link" === t.tagName ||
      ...
      function j(e, t, n, r) {
        return n &&
          ...
          : (0, y.D)(
              e.value,
              Object.assign({}, r.settings.characterReferences, { subset: P }),
            );
      }
      let $ = (function (e, t) {
          let n = t || {};
          ...
          handlers: {
            ...
            element: function (e, t, n, r) {
              ...
              let a = r.schema,
                ...
                s = [];
              "html" === a.space && "svg" === e.tagName && (r.schema = h.YP);
              let c = (function (e, t) {
                  let n;
                  let r = [],
                    i = -1;
                ...
                u = r.all(
                  "html" === a.space && "template" === e.tagName
                    ? e.content
                    : e,
                );
              return (
                ...
                (!c && o && R(e, t, n)) ||
                  ...
                  s.push(">")),
                s.push(u),
                l || (o && T(e, t, n)) || s.push("</" + e.tagName + ">"),
                s.join("")
              );
            },
            raw: function (e, t, n, r) {
              return r.settings.allowDangerousHtml ? e.value : j(e, t, n, r);
            },
      ...
      function G(e) {
        let t;
        let { handlers: n, sanitize: r, ...i } = e || V,
          a = !1;
        "boolean" == typeof r ? (a = !r) : r && (t = r),
          (this.compiler = function (e, r) {
            let l = (0, m.Q)(e, { handlers: n, allowDangerousHtml: a }),
              c = (function (e, t) {
                let n = t || U,
                  r = n.quote || '"';
                if ('"' !== r && "'" !== r)
                  throw Error(
                    "Invalid quote `" + r + "`, expected `'` or `\"`",
                  );
                return {
                  one: K,
                  all: Z,
                  settings: {
                    ...
                    voids: n.voids || g,
                    characterReferences: n.characterReferences || q,
                    closeSelfClosing: n.closeSelfClosing || !1,
                    closeEmptyElements: n.closeEmptyElements || !1,
                  },
                  schema: "svg" === n.space ? h.YP : h.dy,
                  quote: r,
                  alternative: '"' === r ? "'" : '"',
                }.one(
                ...
                { ...i, allowDangerousHtml: a },
              );
            return (
              r.extname && (r.extname = ".html"),
              e &&
              "root" === e.type &&
              c &&
          ...
          tokenize: function (e, t, n) {
            ...
            function l(t) {
              return (
                ...
                e.check(f.w, r.interrupt ? n : s, e.attempt(C, d, u))
              );
            }
            function s(e) {
      ...
      function S(e, t, n, r, i, a) {
        ...
        function d(t) {
          return null === t || 91 === t || 93 === t || (0, c.Ch)(t) || s++ > 999
            ...
            : (e.consume(t), o || (o = !(0, c.xz)(t)), 92 === t ? p : d);
        }
        function p(t) {
          return 91 === t || 92 === t || 93 === t
            ? (e.consume(t), s++, d)
      ...
      let K = {
        ...
        G = {
          ...
          tokenize: function (e, t, n) {
            ...
            function l(t) {
              return 40 === t
                ? e.attempt(W, c, i ? c : u)(t)
                : 91 === t
                  ? e.attempt(Q, c, i ? s : u)(t)
                  : i
                    ? c(t)
                    : u(t);
            }
            function s(t) {
              return e.attempt(X, c, u)(t);
            }
            function c(e) {
              return t(e);
            }
        ...
        ei = {
          91: {
            ...
            tokenize: function (e, t, n) {
              ...
              function u(t) {
                return e.attempt(I, d, d)(t);
              }
              function d(t) {
                return (0, c.xz)(t) ? (0, s.f)(e, p, "whitespace")(t) : p(t);
              }
              function p(a) {
                return null === a || (0, c.Ch)(a)
          ...
          60: {
            ...
            tokenize: function (e, t, n) {
                    ...
                    : 62 === t && 4 === r
                      ...
                      : 63 === t && 3 === r
                        ...
                        : 93 === t && 5 === r
                          ? (e.consume(t), M)
                          : (0, c.Ch)(t) && (6 === r || 7 === r)
                            ? (e.exit("htmlFlowData"), e.check(j, B, C)(t))
                            : null === t || (0, c.Ch)(t)
                              ? (e.exit("htmlFlowData"), C(t))
                              : (e.consume(t), D);
              }
              function C(t) {
                return e.check($, A, B)(t);
              }
              function A(t) {
                return (
              ...
              function O(t) {
                if (62 === t) {
                  let n = a.toLowerCase();
                  return P.includes(n) ? (e.consume(t), I) : D(t);
                }
    ...
    9685: function (e, t, n) {
      ...
      function i(e, t) {
        return e && "run" in e
          ? async function (n, i) {
              let a = (0, r.Q)(n, { file: i, ...t });
              await e.run(a, i);
            }
          : function (n, i) {
              return (0, r.Q)(n, { file: i, ...(e || t) });
            };
      }
    },
    259: function (e, t, n) {
      ...
      function u(e) {
        let t = {
          ...
          tight: !e || "boolean" != typeof e.tight || e.tight,
        };
        return function (e) {
          let n = (function (e, t) {
            let n = t || {},
              r = n.heading ? l(n.heading) : void 0,
              u = (function (e, t, n) {
                let r, c, u;
                let d = "children" in e ? e.children.length : 0,
                  p = n.skip ? l(n.skip) : void 0,
                  f = (0, a.O)(
                    n.parents ||
                      function (t) {
                        return t === e;
                ...
                return (
                  s.reset(),
                  (0, o.Vn)(e, "heading", function (e, a, o) {
                    let l = (0, i.B)(e, { includeImageAlt: !1 }),
                      d = e.data && e.data.hProperties && e.data.hProperties.id,
                      g = s.slug(d || l);
                    if (f(o)) {
                      if (void 0 !== a && t && !r && t.test(l)) {
                        (r = a + 1), (u = e);
                        return;
                      }
                      void 0 !== a && u && !c && e.depth <= u.depth && (c = a),
                        (!c && t) ||
                          (n.minDepth && !(e.depth >= n.minDepth)) ||
                          (n.maxDepth && !(e.depth <= n.maxDepth)) ||
                          (p && p.test(l)) ||
                          m.push({
                            depth: e.depth,
                            children: e.children,
                  ...
                  {
                    index: void 0 === r ? -1 : r,
                    endIndex: void 0 === r ? -1 : c || d,
                    map: m,
                  }
                );
              })(e, r, n);
            return {
              index: r ? u.index : void 0,
              endIndex: r ? u.endIndex : void 0,
              map:
                u.map.length > 0
                  ? (function (e, t) {
                      let { ordered: n = !1, tight: r = !1, prefix: i } = t,
                        a = {
                          type: "list",
                          ordered: n,
                          spread: !1,
                        ...
                        l = -1;
                      for (; ++l < e.length; )
                        e[l].depth < o && (o = e[l].depth);
                      for (l = -1; ++l < e.length; ) e[l].depth -= o - 1;
                      for (l = -1; ++l < e.length; )
                        !(function e(t, n, r) {
                          let i = -1,
                          ...
                          if ("list" === n.type) {
                            if (1 === t.depth)
                                    ...
                                    children: [
                                      {
                                        ...
                                        children: (function e(t) {
                                          ...
                                          for (; ++r < t.length; ) {
                                            let i = (function (t) {
                                              if (
                                                "footnoteReference" === t.type
                                              )
                                                return [];
                                              if (
                                                "link" === t.type ||
                                                "linkReference" === t.type
                                              )
                                                return e(t.children);
                                              if ("children" in t) {
                                                let {
                              ...
                              e(t, n.children[n.children.length - 1], r);
                            else {
                              let i = {
                                type: "listItem",
                                spread: !1,
                              ...
                              n.children.push(i), e(t, i, r);
                            }
                          } else if (a && "list" === a.type)
                            t.depth--, e(t, a, r);
                          else {
                            let i = {
                              type: "list",
                            ...
                            n.children.push(i), t.depth--, e(t, i, r);
                          }
                          if ("list" !== n.type || r.tight) n.spread = !r.tight;
                          else
                            for (n.spread = !1; ++i < n.children.length; )
                              if (n.children[i].children.length > 1) {
                                n.spread = !0;
                                break;
                              }
                        })(e[l], a, { ordered: n, tight: r, prefix: i });
                      return a;
                    })(u.map, n)
                  : void 0,
            };
    ...
    8990: function (e, t, n) {
      ...
      let o = {
        ...
        l = ["cent", "copy", "divide", "gt", "lt", "not", "para", "times"],
        s = {}.hasOwnProperty,
        c = {};
      for (r in o) s.call(o, r) && (c[o[r]] = r);
      function u(e, t, n) {
        let r,
          i = (function (e, t, n) {
            let r = "&#x" + e.toString(16).toUpperCase();
            return n && t && !/[\dA-Fa-f]/.test(String.fromCharCode(t))
              ? r
              : r + ";";
            ...
            (r = (function (e, t, n, r) {
              ...
              if (s.call(c, i)) {
                ...
                return n &&
                  ...
                  !l.includes(e) &&
                  (!r ||
                    (t && 61 !== t && /[^\da-z]/i.test(String.fromCharCode(t))))
                  ? o
                  : o + ";";
              }
              return "";
      ...
      function p(e, t) {
        return i(e, Object.assign({ format: u }, t));
      }
      function f(e, t) {
        return i(e, Object.assign({ format: d }, t));
      }
    },
    9875: function (e, t, n) {
      "use strict";
      ...
      class y extends h {
        ...
        data(e, t) {
          return "string" == typeof e
            ? 2 == arguments.length
              ? (w("data", this.frozen), (this.namespace[e] = t), this)
              : (b.call(this.namespace, e) && this.namespace[e]) || void 0
            : e
              ? (w("data", this.frozen), (this.namespace = e), this)
              : this.namespace;
        }
        freeze() {
        ...
        process(e, t) {
          ...
          return (
            ...
            k("process", this.compiler || this.Compiler),
        ...
        processSync(e) {
          ...
          return (
            ...
            k("processSync", this.compiler || this.Compiler),
        ...
        stringify(e, t) {
          ...
          return k("stringify", r), x(e), r(e, n);
        }
        use(e, ...t) {
          let n = this.attachers,
            r = this.namespace;
          if ((w("use", this.frozen), null == e));
