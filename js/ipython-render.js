load([
  "https://raw.githubusercontent.com/markedjs/marked/v0.3.19/marked.min.js",
  "https://raw.githubusercontent.com/jsvine/notebookjs/65364452aa24253e69d4133eb2ae18877df627a1/notebook.js",
]).then(function () {
  (function (root) {
    ...
    $("article  a").each(function (index, element) {
      if ($(element).attr("href").endsWith(".ipynb")) {
        ...
        var baseUrl = gitcontent.replace(
          /github\.com\/([^/]+)\/([^/]+)\/[^/]+\/([^/]+)\//,
